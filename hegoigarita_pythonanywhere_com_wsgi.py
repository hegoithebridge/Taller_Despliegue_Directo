...
# web application at http://hegoigarita.pythonanywhere.com/
...
#import sys
#
#path = '/home/hegoigarita/path/to/my/app
...
#import sys
#
## assuming your django settings file is at '/home/hegoigarita/mysite/mysite/settings.py'
## and your manage.py is is at '/home/hegoigarita/mysite/manage.py'
#path = '/home/hegoigarita/mysite'
#if path not in sys.path:
#    sys.path.append(path)
#
...
import sys
#
## The "/home/hegoigarita" below specifies your home
## directory -- the rest should be the directory you uploaded your Flask
## code to underneath the home directory.  So if you just ran
## "git clone git@github.com/myusername/myproject.git"
## ...or uploaded files to the directory "myproject", then you should
## specify "/home/hegoigarita/myproject"
path = '/home/hegoigarita/Taller_Despliegue_Directo/'
if path not in sys.path:
    sys.path.append(path)
#
